...
User-facing documentation is maintained in the external documentation site, not in this package repository.

- Public docs: https://aif.cutcode.dev/docs/
- README.md stays a lean landing page with install, quick start, example workflow, and links to the docs site.
- Do not add or maintain local `docs/`, `docs-site/`, or `docs-site-nuxtui/` directories in this repository.
- When product behavior changes, update the external docs-site repository and keep README links pointing to the public site.
...
3. **Documentation** — update the external docs site at https://aif.cutcode.dev/docs/ and `README.md` links/agent names when user-facing behavior changes
