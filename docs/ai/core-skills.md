[← Development Workflow](../essentials/development-workflow.md) · [Back to README](https://github.com/pepperfm/ai-factory/tree/2.x) · [Skill Evolution →](skill-evolution.md)
...
Other skills are intentionally config-agnostic for now and rely on repository context, explicit arguments, or fixed non-configurable paths such as `skill-context`. See [Configuration](../essentials/configuration.md) for the current schema and its limits.

## Workflow Skills

These skills form the core development loop. See [Development Workflow](../essentials/development-workflow.md) for the full diagram and how they connect.
...
- Full protocol and schemas: [Reflex Loop](reflex-loop.md)
...
For the workflow view of where these fit, see [Development Workflow](../essentials/development-workflow.md).
...
- [Development Workflow](../essentials/development-workflow.md) — how workflow skills connect end-to-end
- [Reflex Loop](reflex-loop.md) — strict loop protocol for iterative quality gating
- [Plan Files](../essentials/plan-files.md) — where workflow artifacts are stored
