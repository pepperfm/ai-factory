[← Reflex Loop](reflex-loop.md) · [Back to README](https://github.com/pepperfm/ai-factory/tree/2.x) · [Core Skills →](core-skills.md)
...
- [Reflex Loop](reflex-loop.md) - the workflow these agents support
- [Core Skills](core-skills.md) - slash command reference including `/aif-loop`
- [Configuration](../essentials/configuration.md) - project directories and agent config files
