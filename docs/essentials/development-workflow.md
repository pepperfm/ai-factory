[← Getting Started](../getting-started/index.md) · [Back to README](https://github.com/pepperfm/ai-factory/tree/2.x) · [Reflex Loop →](../ai/reflex-loop.md)
...
For full contracts and state transition rules, see [Reflex Loop](../ai/reflex-loop.md).
...
For full details on all skills including utility commands (`/aif-docs`, `/aif-dockerize`, `/aif-build-automation`, `/aif-ci`, `/aif-commit`, `/aif-skill-generator`, `/aif-reference`, `/aif-security-checklist`), see [Core Skills](../ai/core-skills.md).
...
- [Reflex Loop](../ai/reflex-loop.md) — strict iterative loop contracts and state transitions
- [Core Skills](../ai/core-skills.md) — detailed reference for all workflow and utility skills
