[← Plan Files](plan-files.md) · [Back to README](https://github.com/pepperfm/ai-factory/tree/2.x) · [Extensions →](extensions.md)
...
- [Core Skills](../ai/core-skills.md) — `/aif-security-checklist` for project-level security audits
