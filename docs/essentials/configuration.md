[← Extensions](extensions.md) · [Back to README](https://github.com/pepperfm/ai-factory/tree/2.x) · [Config Reference →](config-reference.md)
...
For full phase contracts and stop conditions, see [Reflex Loop](../ai/reflex-loop.md).
...
- [Getting Started](../getting-started/index.md) — installation, supported agents, first project
- [Development Workflow](development-workflow.md) — how to use the workflow skills
- [Config Reference](config-reference.md) — full `config.yaml` schema and skill usage matrix
- [Reflex Loop](../ai/reflex-loop.md) — contracts and storage layout for `/aif-loop`
