[← Security](security.md) · [Back to README](https://github.com/pepperfm/ai-factory/tree/2.x) · [Configuration →](configuration.md)
...
- [Core Skills](../ai/core-skills.md) — all built-in slash commands
