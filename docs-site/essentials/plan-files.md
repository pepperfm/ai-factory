[← Skill Evolution](../ai/skill-evolution.md) · [Back to README](https://github.com/pepperfm/ai-factory/tree/2.x) · [Security →](security.md)
...
- [Development Workflow](development-workflow.md) — how plan files fit into the development loop
- [Core Skills](../ai/core-skills.md) — full reference for `/aif-fix`, `/aif-evolve`, and other skills
