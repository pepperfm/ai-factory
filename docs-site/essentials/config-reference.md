[← Configuration](configuration.md) · [Back to README](https://github.com/pepperfm/ai-factory/tree/2.x)
...
- [Core Skills](../ai/core-skills.md) — full skill reference
- [Development Workflow](development-workflow.md) — where config-aware workflow skills fit end to end
