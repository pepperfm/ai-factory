[← Back to README](https://github.com/pepperfm/ai-factory/tree/2.x) · Next: [Development Workflow →](../essentials/development-workflow.md)
...
- [Development Workflow](../essentials/development-workflow.md) — understand the full flow from plan to commit
- [Reflex Loop](../ai/reflex-loop.md) — run iterative generate → evaluate → critique → refine cycles
- [Core Skills](../ai/core-skills.md) — all available slash commands
- [Configuration](../essentials/configuration.md) — customize `.ai-factory.json` and MCP servers
