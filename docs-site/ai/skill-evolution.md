[← Core Skills](core-skills.md) · [Back to README](https://github.com/pepperfm/ai-factory/tree/2.x) · [Plan Files →](../essentials/plan-files.md)
...
- [Development Workflow](../essentials/development-workflow.md) — where `/aif-evolve` fits in the development loop
- [Core Skills](core-skills.md) — full reference for `/aif-evolve` and other skills
- [Plan Files](../essentials/plan-files.md) — patches, plans, and other workflow artifacts
