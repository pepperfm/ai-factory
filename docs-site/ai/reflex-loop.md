[← Development Workflow](../essentials/development-workflow.md) · [Back to README](https://github.com/pepperfm/ai-factory/tree/2.x) · [Subagents →](subagents.md)
...
- [Development Workflow](../essentials/development-workflow.md) - where `/aif-loop` fits in the overall process
- [Subagents](subagents.md) - Claude-only loop roles used to split planning, generation, and evaluation
- [Core Skills](core-skills.md) - full command reference including `/aif-loop`
- [Configuration](../essentials/configuration.md) - `.ai-factory/` storage layout
